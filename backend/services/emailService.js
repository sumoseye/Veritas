...
async function sendCitationEmail(citationData) {
    ...
    console.log('   From:', recipient_name);
...
Traffic Enforcement Department
    ...
    try {
        ...
        // Log system activity
        await db.query(`
            INSERT INTO system_activity_log (activity_type, description, related_citation_id)
            VALUES ('Email Sent', ?, ?)
        `, [`Email sent to ${recipient_email} for ticket ${ticket_number}`, citation_id]);
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="decision">
                ...
                <p><strong>Amount:</strong> $${fine_amount}</p>
